...
//     <HomeLayout>
//       <div className="min-h-[90vh] pt-5 text-white">
//         <div className="flex flex-col flex-wrap gap-5 mt-10 sm:mt-20">
//           <h1 className="text-center text-3xl font-semibold text-yellow-500">Admin Dashboard</h1>

//           <div className="sm:grid sm:grid-cols-2 gap-5 m-auto mx-4 sm:mx-10">
//             <div className="flex flex-col items-center gap-5 p-4 sm:p-5 shadow-lg rounded-md">
//               <div className="w-64 sm:w-80 h-64 sm:h-80">
//                 <Pie data={userData} />
//               </div>

//               <div className="grid grid-cols-2 gap-3">
//                 <div className="flex items-center justify-between p-3 sm:p-5 rounded-md shadow-md">
//                   <div className="flex flex-col items-center">
//                     <p className="font-semibold">Registered Users</p>
...
//                   <div className="flex flex-col items-center">
//                     <p className="font-semibold">Total Revenue</p>
//                     <h3 className="text-2xl sm:text-4xl font-bold">{allPayments?.count * 499}</h3>
//                   </div>
...
//           <div className="mx-4 sm:mx-[10%] w-full self-center flex flex-col items-center justify-center gap-5 mb-10">
//             <div className="flex flex-col lg:flex-row gap-5 w-full items-center lg:justify-between">
...
//                   <th>S No.</th>
//                   <th>Course Title</th>
//                   <th className='hidden lg:block'>Course Category</th>
//                   <th className='hidden lg:block'>Instructor</th>
//                   <th className='hidden lg:block'>Total Lectures</th>
//                   <th>Course Description</th>
//                   <th>Actions</th>
//                 </tr>
//               </thead>
...
//                       ></textarea>
//                     </td>
//                     <td className='hidden  lg:block'>{element?.category}</td>
//                     <td className='hidden lg:block'>{element?.createdBy}</td>
//                     <td className='hidden  lg:block'>{element?.numberOfLectures}</td>
//                     <td className="max-w-full overflow-hidden text-ellipsis whitespace-nowrap">
//                       <textarea
//                         readOnly
//                         className="w-full h-auto bg-transparent resize-none"
